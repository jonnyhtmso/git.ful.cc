...
apt update && apt-get install -y vim iproute2 git cadaver gitlab-runner curlftpfs redis golang cron iputils-ping unzip nginx&& /etc/init.d/redis-server start && \
